...
const Footer = () => {
    return (
        <div className=" relative " id="contact ">
            <div className="w-[90%] md:w-[80%]  md:flex md:items-center md:justify-center  mx-auto relative border-t-[3px] border-t-blue-400 bg-white -mb-10 z-10 p-4 rounded-md">
            ...
            <div className="bg-[#151C24] h-72 flex justify-center items-center relative ">
                <div className=" flex flex-col gap-10 justify-center items-center h-48 py-5">
                    <p className="text-white text-md text-center ">
                        Living, learning, and & leveling up <br /> one day at
                        time ��
                    ...
                    >
                        <div className="w-2/3 md:w-1/3  flex justify-evenly items-center  gap-4">
                            <Link
                            ...
                            <Link
                                href={
                                    "https://www.linkedin.com/in/usama-riaz666"
                                }
                                rel="noopener noreferrer"
                                target="_blank"
                            >
